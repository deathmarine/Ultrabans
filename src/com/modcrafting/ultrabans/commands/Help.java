...
public class Help implements CommandExecutor{
	...
	public boolean onCommand(CommandSender sender, Command command, String commandLabel, String[] args) {
		...
		if (server){
			...
			sender.sendMessage("/umute      (unmute/{player}) {player}");
			...
			sender.sendMessage("/ujail (set/pardon/{player}) {player}");
		...
		if (plugin.permission.has(player, "ultraban.jail"))sender.sendMessage(ChatColor.GRAY + "/ujail (set/pardon/{player}) {player}");
